    ...
    <div className="px-4 sm:px-6 lg:px-8 flex flex-1 justify-center py-5">
      <div className="layout-content-container flex flex-col max-w-[960px] flex-1">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
          <h1 className="text-[#121416] tracking-light text-2xl sm:text-3xl lg:text-[32px] font-bold leading-tight">
            カテゴリ管理
          </h1>
          <div className="flex gap-3">
            ...
            >
              <span className="text-sm font-bold">管理画面に戻る</span>
            </Link>
            <button
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex justify-end gap-3">
                <button
                  type="button"
                  onClick={resetForm}
                  className="px-4 py-2 bg-gray-200 text-[#121416] rounded-lg hover:bg-gray-300 transition-colors"
                >
                  キャンセル
                </button>
                <button
